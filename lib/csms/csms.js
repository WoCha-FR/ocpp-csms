...
class CSMS {
  ...
  async initServer() {
    ...
    // Server Auth
    this.server.auth(this.authChargeBoxWs.bind(this))
    // Server Events
    ...
    this.server.on('client', async (client) => {
      ...
      client.handle('BootNotification', this.cbBootNotif.bind(this, client))
      // handler for StatusNotification
      client.handle('StatusNotification', this.cbStatusNotif.bind(this, client))
      // handler for HeartBeat
      client.handle('Heartbeat', this.cbHeartBeat.bind(this, client))
      // handler for Authorize
      client.handle('Authorize', this.cbAuthorize.bind(this, client))
      // handler for StartTransaction
      client.handle('StartTransaction', this.cbStartTransaction.bind(this, client))
      // handler for StopTransaction
      client.handle('StopTransaction', this.cbStopTransaction.bind(this, client))
      // handler for MeterValues
      client.handle('MeterValues', this.cbMeterValues.bind(this, client))
  ...
  /* OCPP1.6 Functions */
  async authChargeBoxWs(accept, reject, handshake) {
  ...
  async cbBootNotif(client, {params, reply}) {
  ...
  async cbStatusNotif(client, {params, reply}) {
    // Send response
    reply({})
    // Connector 0 ignored
  ...
  async cbAuthorize(client, {params}) {
  ...
  async cbStartTransaction(client, {params, reply}) {
  ...
  async cbStopTransaction(client, {params, reply}) {
  ...
  async cbMeterValues(client, {params, reply}) {
