...
export default new class WebApp {
  ...
  async initWebUI () {
    ...
    this.app.post('/admin/user/add', this.checkAdminAuthenticated, checkSchema(AdminController.UserSchema), AdminController.addUser)
    ...
    this.app.post('/admin/rfid/delete', this.checkAdminAuthenticated, checkSchema(BaseController.IdSchema), RfidController.delRfidTag)
