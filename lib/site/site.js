...
export default new class WebApp {
  ...
  async initWebUI () {
    ...
    // ADMIN - Charger
    this.app.get('/adminstations', this.checkIsAdmin, AdminController.getAllChargers)
    this.app.post('/stations/add', this.checkIsAdmin, checkSchema(AdminController.ChargerSchema), AdminController.addCharger)
    this.app.post('/station/delete', this.checkIsAdmin, checkSchema(AdminController.ChargerId), AdminController.delCharger)
    this.app.get('/station/edit/:chargerId', this.checkIsAdmin, checkSchema(AdminController.ChargerId), AdminController.formUpdCharger)
    this.app.post('/station/edit', this.checkIsAdmin, checkSchema(AdminController.updChargerSchema), AdminController.updCharger)
    this.app.post('/refreshPendings', this.checkIsAdmin, AdminController.ajaxPendings)
    this.app.post('/station/:ocppName/register', this.checkIsAdmin, checkSchema(AdminController.PendingSchema), AdminController.registerPending)
    this.app.get('/station/:ocppName/diagnostic', this.checkIsAdmin, checkSchema(AdminController.OcppidSchema), AdminController.getDiagnostic)
