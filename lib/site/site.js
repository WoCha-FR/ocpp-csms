...
export default new class WebApp {
  ...
  async initWebUI () {
    ...
    this.app.get('/admin/ocppdefault', this.checkAdminAuthenticated, AdminController.formConfigOcpp)
    this.app.post('/admin/ocppdefault', this.checkAdminAuthenticated, AdminController.dataConfigOcpp)
    this.app.post('/admin/ocppdefault/edit', this.checkAdminAuthenticated, checkSchema(AdminController.ConfOcppSchema), AdminController.updateConfigOcpp)
