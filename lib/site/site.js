...
export default new class WebApp {
  ...
  async initWebUI () {
    ...
    // TODO: AJAX retour function quand plus loggué.
    ...
    // STATIONS - Admin & Owner AJAX
    this.app.post('/ajax/stations_status', this.checkIsGranted, StationsController.ajaxOnline)
    // CHARGEUR - Admin & Owner AJAX
    this.app.post('/ajax/charger_status', this.checkIsGranted, checkSchema(BaseController.OcppidSchema), ChargerController.ajaxGetOnline)
    this.app.post('/ajax/connectors_status', this.checkIsGranted, checkSchema(BaseController.OcppidSchema), ChargerController.ajaxGetChargerConnsStatus)
    // CHARGEUR - Admin
    ...
    this.app.post('/ajax/charger_logs', this.checkIsAdmin, checkSchema(ChargerController.LogsSchema), ChargerController.ajaxGetLogs)
