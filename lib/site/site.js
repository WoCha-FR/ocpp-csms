...
class WebApp {
  ...
  async initWebUI() {
    ...
    this.app.post('/ajax/upduserdashboard', this.ajaxIsAuthenticated, BaseController.ajaxUpdUserDashboard)
    this.app.post(
    ...
    this.app.get('/forbidden', (req, res) => {
      let errormsg = { code: '403', title: 'Accès refusé', message: "Vous n'êtes pas autorisé à consulter cette page." }
      // Ajax Request
