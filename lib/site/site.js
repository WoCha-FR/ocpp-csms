...
export default new class WebApp {
  ...
  async initWebUI () {
    ...
    this.app.post('/admin/sites/add', this.checkAdminAuthenticated, checkSchema(AdminController.SiteSchema), AdminController.addSite)
    this.app.get('/admin/site/edit/:elemId', this.checkAdminAuthenticated, checkSchema(AdminController.IdSchema), AdminController.formUpdSite)
    ...
    this.app.post('/admin/site/delete', this.checkAdminAuthenticated, checkSchema(AdminController.IdSchema), AdminController.delSite)
    // USERS
    ...
    this.app.post('/admin/users/add', this.checkAdminAuthenticated, checkSchema(AdminController.UserSchema), AdminController.addUser)
    this.app.get('/admin/users/edit/:elemId', this.checkAdminAuthenticated, checkSchema(AdminController.IdSchema), AdminController.formUpdUser)
    this.app.post('/admin/users/edit', this.checkAdminAuthenticated, checkSchema(AdminController.UserUpdSchema), AdminController.updUser)
    this.app.post('/admin/users/delete/', this.checkAdminAuthenticated, checkSchema(AdminController.IdSchema), AdminController.delUser)
    // RFIDS
    ...
    this.app.post('/admin/rfid/add', this.checkAdminAuthenticated, checkSchema(AdminController.RfidTagSchema), RfidController.addRfidTag)
    this.app.get('/admin/rfid/edit/:elemId', this.checkAdminAuthenticated, checkSchema(AdminController.IdSchema), AdminController.formUpdRfidTag)
    ...
    this.app.post('/admin/rfid/delete', this.checkAdminAuthenticated, checkSchema(AdminController.IdSchema), RfidController.delRfidTag)
