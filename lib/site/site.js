...
export default new class WebApp {
  ...
  async initWebUI () {
    ...
    this.app.get('/admin/station/:ocppName/diagnostic', this.checkIsAdmin, checkSchema(BaseController.OcppidSchema), AdminController.getStationDiag)
    this.app.put('/admin/station/:ocppName/diagnostic/:fileName', AdminController.recvDiagnosticFile)
    // OWNER - Stations
    this.app.get('/site/stations', this.checkIsOwner, OwnerController.getAllStations)
